            ...
            <span className="label__content">
              ...
              />
                <button type='button' className='visible_password' onClick={togglePasswordVisibility}>
                  {passwordVisible ? (
                      <img src={HiddenPasswordImage} alt="Показать пароль" width='20' height='20' className='visible_password__image'/>
                  ): (
                      <img src={VisiblePasswordImage} alt="Скрыть пароль" width='20' height='20' className='visible_password__image'/>
                  )}
              </button>
            </span>
